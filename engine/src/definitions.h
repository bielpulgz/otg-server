...
static constexpr auto STATUS_SERVER_NAME = "OTG Custom";
static constexpr auto STATUS_SERVER_VERSION = "1.5";
static constexpr auto STATUS_SERVER_CREDITS = "Mateus Roberto, Johncore, Erick Nunes, Leonardo Pereira, Marson Schneider, Mark Samman, OTXServer (Mattyx Gomez), OTG Contributors and The Forgotten Server Developers";
